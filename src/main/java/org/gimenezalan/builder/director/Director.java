package org.gimenezalan.builder.director;

import org.gimenezalan.builder.builders.Builder;
...
public class Director {
    public void constructSportsCar(Builder builder) {
        ...
        builder.setSeats(2);
        builder.setEngine(new Engine(3.0, 0, true));
    ...
    public void constructCityCar(Builder builder) {
        ...
        builder.setSeats(2);
        builder.setEngine(new Engine(1.2, 0, false));
